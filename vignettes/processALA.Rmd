...
The next step is downloading occurrence data for an accepted taxonomic name. This is performed by the function _fetchALAdata()_.
...
Here are two worked examples which can be a starting point for developing your own workflows.

### Single taxon which is an accepted name



### Single taxon which is a synonym of an accepted name
